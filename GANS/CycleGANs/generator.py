...
class ConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels, down=True, use_act= True, **kwags):
        super().__init__()
        self.conv= nn.Sequential(
            ...
            if down
            else nn.ConvTranspose2d(in_channels, out_channels, **kwags),
