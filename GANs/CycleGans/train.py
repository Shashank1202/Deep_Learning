...
def train(disc_H, disc_Z, gen_Z, gen_H, loader, opt_disc, opt_gen, l1, mse, d_scaler, g_scaler):
    ...
    for idx, (zebra, horses) in enumerate(loop):
        ...
        with torch.cuda.amp.autocast():
            ...
            cycle_horse_loss = l1(horses, cycle_horse)

            # identity loss (remove these for efficiency if you set lambda_identity=0)
           #identity_zebra = gen_Z(zebra)
           #identity_horse = gen_H(horses)
           #identity_zebra_loss = l1(zebra, identity_zebra)
           #identity_horse_loss = l1(horses, identity_horse)
...
def main():
    ...
    dataset= HorseZebraDataset(
        root_horse= "Horse2Zebra/train/horses", root_zebra="Horse2Zebra/train/zebra",transform= config.transforms
    )
